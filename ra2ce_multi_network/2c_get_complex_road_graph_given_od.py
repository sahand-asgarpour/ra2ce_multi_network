...
with open(root_folder.joinpath(
        f'static/output_graph/road_complex_graph_origin_destinations_mapped_{output_name}.p'), 'rb') as f:
...
with open(root_folder.joinpath(
        f'static/output_graph/road_simple_graph_origin_destinations_mapped_{output_name}.p'), 'rb') as f:
